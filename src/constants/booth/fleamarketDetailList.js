...
export const fleamarketDetailList = {
  ccJuice: {
    name: '씨씨주스',
    intro: '신선한 과일로 만든 주스와 화채로\n더운 날씨를 이겨낼 수 있는 곳! 🍊🍇',
    goods: [
      { name: '생과일 화채', price: 5000, img: ccJuice1 },
      { name: '오렌지 주스', price: 4000, img: ccJuice2 },
    ],
  },
  almak: {
    name: '올막 (almak)',
  ...
  modori: {
    ...
    intro: '뚝딱뚝딱 목수들의\n아기자기한 소품 가게 🌳🪓',
    goods: [
      { name: '케이크 키링', price: 20000, img: modori1 },
      { name: '도넛 키링', price: 15000, img: modori2 },
      { name: '물고기 키링', price: 15000, img: modori3 },
      { name: '로봇 키링', price: 12000, img: modori4 },
      { name: '물고기 키링 (통통)', price: 15000, img: modori5 },
      { name: '물고기 키링 (빼빼)', price: 8000, img: modori6 },
      { name: '잡동사니', price: 5000, img: modori7 },
      { name: '책갈피', price: 10000, img: modori8 },
    ],
  },
  sajuraplz: {
    name: 'sajuraplz',
    intro: '내가 만든 도자기 너를 위해 구웠지 🫵🍶',
    goods: [
  ...
  kawaii: {
    name: '겨운거 ^..^',
    intro: '손으로 만든 특별한 뜨개 작품으로\n귀여움과 애정을 전합니다 🧶🍅',
    goods: [
      { name: '버섯 키링', price: 4000, img: kawaii1 },
      { name: '채소 키링 set', price: 12000, img: kawaii2 },
      { name: '금붕어 키링', price: 8000, img: kawaii3 },
      { name: '흰동가리 키링', price: 10000, img: kawaii4 },
      { name: '리본 키링', price: 3000, img: kawaii5 },
      { name: '해골 키링', price: 5000, img: kawaii6 },
      { name: '토마토 티코스터', price: 3500, img: kawaii7 },
      { name: '잔디 티코스터', price: 3500, img: kawaii8 },
      { name: '바다 티코스터', price: 10000, img: kawaii9 },
      { name: '피자 티코스터', price: 10000, img: kawaii10 },
    ],
  },
  aiesec: {
    name: 'AIESEC과 함께\n MZ한 친환경 실천 어때?',
    intro: '다회용 텀블러 & 키링으로 변신 가능한\n 손뜨개 티코스터 🏵️🥤',
    goods: [
      { name: '텀블러', price: 13900, img: aiesecImg1 },
      { name: '손뜨개 티코스터', price: 3700, img: aiesecImg2 },
      { name: '텀블러+티코스터 set', price: 15000, img: aiesecImg3 },
    ],
  },
};
